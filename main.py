...
if SADECE_MAX == True:
    ...
    print(f"Orjinal resmin {0 if aci == 360 else aci} derece rotate edilmis hali icin: top-left = {maks_koor}, bottom-right={maks_koor+[w,h]}, corr = {corr}")
else:
    for i in range(len(corr_degerleri)):
        ...
        print(f"Orjinal resmin {0 if aci == 360 else aci} derece rotate edilmis hali icin: top-left = {index}, bottom-right={index+[w,h]}, corr = {corr}")